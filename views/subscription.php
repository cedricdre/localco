                ...
                <div class="row g-lg-5 align-items-center">
                    ...
                    <div class="col-12">
                        <div class="text-center">
                            ...
                            <button type="button" class="btn btn-lg m-2 btn-outline-danger">Tous les mois</button>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6">
                        <div>
                    ...
                    <div class="col-12 col-lg-6">
                        <div>
                            <h3 class="fw-bold"><span class="text-danger fs-2 fw-bolder">4. </span>Le rappel</h3>
                            <p class="fs-5">Préparez-vous à recevoir un rappel amical pour votre prochain panier à composer, car nous ne voulons pas que vous manquiez l'occasion de régaler vos papilles à nouveau !</p>
                        </div>
                    </div>
