    ...
    <div class="container pt-4 pt-lg-0 text-light">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-6 col-xl-5">
                <img src="/public/assets/img/cover.webp" class="img-fluid pt-lg-4" alt="Jeune femme jardinier tablier chapeau tenant panier plein legumes tomates pres son oeil souriant">
            </div>
        </div>
    </div>
</section>
...
<section class="my-6 text-center">
    <div class="container mb-lg-5 pt-lg-2">
        ...
        <div class="row g-2 g-lg-4" data-aos="fade-up">
            ...
            <div class="col-6 col-lg-3">
                <div>
                    ...
                    <p class="fs-5">Nous préparons avec soin vos commandes !</p>
                </div>
            </div>
            <div class="col-6 col-lg-3">
                <div>
