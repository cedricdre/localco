...
<section>
    ...
    <form method="POST">
        <div class="mb-4">
            ...
            <input type="text" name="pickup_name" class="form-control" id="pickup_name" aria-describedby="pickup_nameHelp" required pattern="<?= REGEX_NAME ?>" placeholder="Ex : Localco Amiens Centre">
            <div id="pickup_nameHelp" class="form-text text-danger"><?= $error['pickup_name'] ?? '' ?></div>
        </div>
        <div class="mb-4">
            <label for="address" class="form-label">Adresse*</label>
            <input type="text" name="address" class="form-control" id="address" aria-describedby="addressHelp" required pattern="<?= REGEX_ADRESS ?>" placeholder="Ex : 1 rue des Champs">
            <div id="addressHelp" class="form-text text-danger"><?= $error['address'] ?? '' ?></div>
        </div>
        <div class="row">
            <div class="col-md-6 mb-4">
                <label for="zip" class="form-label">Code postal*</label>
                <input type="text" inputmode="numeric" name="zip" class="form-control" id="zip" aria-describedby="zipHelp" required pattern="<?= REGEX_POSTAL_CODE ?>" placeholder="Ex : 80000">
                <div id="zipHelp" class="form-text text-danger"><?= $error['zip'] ?? '' ?></div>
            </div>
            <div class="col-md-6 mb-4">
                <label for="city" class="form-label">Ville*</label>
                <input type="text" name="city" class="form-control" id="city" aria-describedby="cityHelp" required pattern="<?= REGEX_CITY ?>" placeholder="Ex : Amiens">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="opening_hours" class="form-control" id="opening_hours" aria-describedby="opening_hoursHelp" required placeholder="Ex : 9h00 - 17h00">
